  ...
  return (
    <div className='space-y-10'>
      <div>
        ...
        <p className='mt-2 text-muted-foreground'>{t('docs.alertDialog.desc')}</p>
        <p className='mt-1 text-xs text-muted-foreground'>
          {t('docs.source')}: <code className='rounded bg-muted px-1 py-0.5'>src/components/ui/alert-dialog.tsx</code>
        </p>
      </div>

      <section className='space-y-4'>
        <h2 className='text-xl font-semibold'>{t('docs.whenToUse')}</h2>
        <p className='text-sm text-muted-foreground'>{t('docs.alertDialog.whenToUse')}</p>
      </section>
  ...
  return (
    <AlertDialog>
      ...
      <section className='space-y-4'>
        ...
        <PropsTable title='AlertDialogContent' data={CONTENT_PROPS} />
      </section>
    </div>
  )
}
